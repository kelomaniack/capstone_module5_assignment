(function() {
  ...
  /*
   * loads the current user with his avatar image
   */
  function load() {
  ...
  /*
   * function to get the user's image (if there is one) by a promise 
   * fetches the image to the variable vm.userImage
   */
